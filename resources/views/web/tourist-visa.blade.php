                                        ...
                                        <div class="tab-pane fade in active" id="tab1default">
                                            ...
                                            <form>
                                                <div class="col-md-12 col-sm-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="email">Upload Hotel booking*</label>
                                                        ...
                                                        <br>
                                                        <label for="email">Upload Your Flight Ticket*</label>
                                                        ...
                                                        <br>
                                                        <label for="email">Or drag and drop files below</label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <button type="button" class="btn main-btn-style">Save</button>
                                                        &nbsp;
