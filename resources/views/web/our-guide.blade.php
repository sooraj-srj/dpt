                ...
                <div class="row">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1default">
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <ul class="flags">
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/thumb/09f7fe194d3c6c3">ENGLISH
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/63a172eef5fe348">ENGLISH
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/a699237f420e97c">ITALIAN
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/4002b81b5546f67">GERMAN
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/7f160b43e478f85">PORTUGUESE
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/fb8c136303c64d6">SPANISH
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/a557c9125627acd">FRENCH
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/6ce4aec2a581a46">DUTCH
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/64d064ee74a7a6e">GREEK
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/2056f1a2bd000c4">TURKISH
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/a29e538e0392ce7">MALAY
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/4784861267f3549">BAHASA
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/9bcd54abe5d8524">JAPANES
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/c2c472367d75ec6">RUSSIAN
                                                </li>
                                                <li><img alt="" class="pyro-image alignment-none" data-pyroimage="true"
                                                         src="http://www.dubaiprivatetour.com/index.php/files/large/bf7f59f397801ce">CHINESE
                                                </li>
                                            </ul>
                    ...
                    <div id="content-wrap2">
                        ...
                        <div class="panel with-nav-tabs panel-default">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab5default" data-toggle="tab">Book This Tour</a></li>
                                    ...
                                    <div class="tab-pane fade in active" id="tab5default">
                                        ...
                                        <form>
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="button" class="btn main-btn-style">Confirm Booking
                                                    </button>
                                                    &nbsp;
                                    ...
                                    <div class="tab-pane fade" id="tab8default">
                                        <div id="jssor_1"
                                            ...
                                            <div data-u="slides"
                                                ...
                                                <div data-p="144.50"><img data-u="image" src="images/img/01.jpg"/> <img
                                                            data-u="thumb" src="images/img/thumb-01.jpg"/></div>
                                            ...
                                            <span data-u="arrowleft" class="jssora05l"
                                                  style="top:158px;left:8px;width:40px;height:40px;"></span> <span
                                                    ...
                                                    style="top:158px;right:8px;width:40px;height:40px;"></span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="item-main-div1"><img src="images/carous1/fit (1).jpg"
                                ...
                                <div class="item--footer-1">
                                    <div class="col-md-6"><i class="fa fa-clock-o" aria-hidden="true"></i> &nbsp;4 Hours
                                    </div>
